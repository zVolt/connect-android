...
public class FragmentBackground extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_background,
				container, false);
	...
	/*
	 * @Override public void onStart(){ super.onStart(); //onClickButtonStart();
	 * 
	 * }
	 * 
	 * public void onClickButtonStart(){//View view){ Intent intent=new
	 * Intent(getActivity().getApplicationContext(), BackgroundActivity.class);
	 * Utility.log("onClick", "onClickButtonStart");
	 * //intent.setData(Uri.parse("Background activity"));
	 * intent.putExtra("count", "1"); intent.putExtra("receiver",
	 * getResultReceiver()); getActivity().startService(intent); }
	 * 
	 * 
	 * 
	 * 
	 ...
	 * { // TODO Auto-generated method stub EditText showcount;
